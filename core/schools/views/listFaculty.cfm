...
<cfscript>	
	...
	qFaculty	 = request.event.getArg('qFaculty');
...
<body>
<div class="container">
	<table cellpadding="0" cellspacing="0" border="0" class="bordered-table zebra-striped" id="example" width="100%">
	<thead>
		<tr>
			<th>znumber</th>
			<th>Email</th>
	...
	<cfloop query="qFaculty">
		<tr>
			...
			<td>#last_name#</td>
			<td>
				<a href="index.cfm?event=showFacultyDetails&id=#id#">Details</a> |
				<a href="index.cfm?event=facultyDetailsPDF&id=#id#">PDF</a> |
				<a href="index.cfm?event=facultyDetailsXLS&id=#id#">XLS</a>
			</td>
		</tr>
	</cfloop>
	</tbody>
