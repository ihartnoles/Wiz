...
<cfcomponent displayname="schools" output="false">
		...
		<cfproperty name="enabled" type="boolean" default="" />
	...
	--->
	<cffunction name="init" access="public" returntype="schools" output="false">
		...
		<cfargument name="enabled" type="string" required="false" default="" />
		...
		<cfset setenabled(arguments.enabled) />
	...
	PUBLIC FUNCTIONS
	--->
	<cffunction name="setMemento" access="public" returntype="schools" output="false">
	...
	<cffunction name="validate" access="public" returntype="array" output="false">
		...
		<!--- enabled --->
		<cfif (NOT len(trim(getenabled())))>
			<cfset thisError.field = "enabled" />
			<cfset thisError.type = "required" />
			<cfset thisError.message = "enabled is required" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
		<cfif (len(trim(getenabled())) AND NOT isBoolean(trim(getenabled())))>
			<cfset thisError.field = "enabled" />
			<cfset thisError.type = "invalidType" />
			<cfset thisError.message = "enabled is not boolean" />
			<cfset arrayAppend(errors,duplicate(thisError)) />
		</cfif>
	...
	<cffunction name="getenabled" access="public" returntype="string" output="false">
