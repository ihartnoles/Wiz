...
<cfcomponent displayname="departmentsGateway" output="false">
	<cffunction name="init" access="public" output="false" returntype="departmentsGateway">
	...
	<cffunction name="getByAttributesQuery" access="public" output="false" returntype="query">
		...
		<cfif structKeyExists(arguments,"school_id") and len(arguments.school_id)>
	...
	<cffunction name="getDepartmentsQuery" access="public" output="false" returntype="query">
		<cfargument name="id" type="numeric" required="false" />
		<cfargument name="name" type="string" required="false" />
		<cfargument name="description" type="string" required="false" />
		<cfargument name="school_id" type="numeric" required="false" />
	...
	<cffunction name="getByAttributes" access="public" output="false" returntype="array">
		...
		<cfloop from="1" to="#qList.recordCount#" index="i">
			<cfset tmpObj = createObject("component","departments").init(argumentCollection=queryRowToStruct(qList,i)) />
